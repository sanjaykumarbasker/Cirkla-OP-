<nav class="fixed top-0 left-0 right-0 z-50 bg-paper/90 backdrop-blur-nav border-b border-rule">
    <div class="max-w-site mx-auto px-6 md:px-12 h-nav flex items-center justify-between">
        <a href="/" class="flex items-center gap-2 font-serif font-bold text-[18px] tracking-[-0.5px] text-green no-underline flex-shrink-0 uppercase">
            <img src="/images/copar/logo.svg" alt="COPAR logo" class="w-7 h-7 object-contain">
            COPAR
        </a>
        ...
        <ul class="hidden md:flex items-center gap-9 list-none m-0 p-0">
            ...
            <li><a href="/certifications" class="font-mono text-[12px] tracking-[0.08em] uppercase font-medium leading-none flex items-center no-underline transition-colors duration-200 {{ ($activePage ?? null) === 'standards' ? 'text-ink' : 'text-ink-50 hover:text-ink' }}">Standards</a></li>
